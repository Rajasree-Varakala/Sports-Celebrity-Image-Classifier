...
if __name__ == '__main__':
    ...
    print(classify_image(None, "./test_images/test5.jpg")) # Inconsistent result could be due to https://github.com/scikit-learn/scikit-learn/issues/13211
    print(classify_image(None, "./test_images/test6.jpg"))
    print(classify_image(None, "./test_images/test7.jpeg"))
    print(classify_image(None, "./test_images/test8.jpg"))
    print(classify_image(None, "./test_images/test9.jpg"))